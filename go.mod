module github.com/LubyRuffy/goflow
...
require (
	...
	github.com/fraugster/parquet-go v0.11.0 // indirect
...
replace github.com/LubyRuffy/gofofa => github.com/allukaZod/gofofa v0.2.2
